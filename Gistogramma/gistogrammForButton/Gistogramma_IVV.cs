...
{
    class Gistogramma_IVV : Gistogramma_numeric
    {
        public Gistogramma_IVV(long[,] osob, int b1) : base(osob, b1) {
        ...
        public override void set_diffrence()
        {
            ...
            {
                if ((osob_p[3, i + 1] - osob_p[3, i]) > 300000 && osob_p[3, i + 1] != osob_p[3, i])
                {

                    diffrence_4[i - 1] = (System.Convert.ToDouble(osob_p[5, i]) - System.Convert.ToDouble(osob_p[3, i])) / (System.Convert.ToDouble(osob_p[3, i + 1]) - System.Convert.ToDouble(osob_p[3, i]));
