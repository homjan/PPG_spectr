...
{
    class Gistogramma_IDV : Gistogramma_numeric
    {
        public Gistogramma_IDV(long[,] osob, int b1) : base(osob, b1) {
        ...
        public override void set_diffrence()
        {
            ...
            {
                if ((osob_p[3, i + 1] - osob_p[3, i]) > 300000 && osob_p[4, i] > 0)//&& osob[8, i]> 1.1*osob[9, i])
                {
                    diffrence_4[i - 1] = System.Convert.ToDouble(osob_p[6, i]) / System.Convert.ToDouble(osob_p[4, i]);
